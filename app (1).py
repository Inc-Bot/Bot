...
DEFAULT_SETTINGS = {
    ...
    '_id': 'bot_settings',
    'transfer_limits': {'standart': 500000, 'assassin': 1000000, 'vip': 1500000, 'pro': 3000000, 'max': 10000000},
    ...
    'pass_rewards': { # Награды за уровни
        ...
        40: {'type': 'normal_money', 'amount': 2500000},  # мифический кейс
...
async def command_titles_handler(message: Message):
    ...
    if not titles:
        await message.answer("🏆 У вас еще нет титулов. Попросите администратора выдать вам титул!", parse_mode="HTML")
        return
...
async def command_invite_handler(message: Message):
    ...
    await message.answer(
        ...
        f"Награда: от <b>10,000</b> монет + <b>1,000</b> очков Inc Pass за каждого нового пользователя. "
...
async def show_pass_help(call: CallbackQuery):
    help_text = (
        ...
        "За каждого нового приглашённого друга реферер получает <b>+1,000 очков Inc Pass</b> и от <b>10,000</b> монет.\n"
